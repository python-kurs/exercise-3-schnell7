...
Path('C:/Users/hans/Documents/PythonKursGit/exercise-3-schnell7/solutions').mkdir(parents=True, exist_ok=True) 
...
with open(base_dir + "\solutions\count_test_anacondaprompt.csv", "w") as file:
